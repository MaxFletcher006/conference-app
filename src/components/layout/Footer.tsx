...
export function Footer() {
  ...
  return (
    <footer style={{ borderTop: '1px solid var(--border)', background: 'var(--bg-2)' }}>
      <div className="max-w-[1240px] mx-auto px-6 md:px-12" style={{ padding: '64px 0' }}>
          ...
          <div style={{ gridColumn: 'span 2' }}>
            <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20, textDecoration: 'none' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: 15, letterSpacing: '-0.01em', color: 'var(--blue)', textTransform: 'uppercase' }}>Accelerator</span>
              </div>
            </Link>
