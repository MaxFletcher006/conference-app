  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      <nav
        ...
        style={{ background: 'rgba(8,8,16,0.95)', borderBottom: '1px solid var(--border)' }}
      >
        <div className="max-w-[1240px] mx-auto px-6 md:px-12 flex h-16 items-center justify-between">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-3">
            <div className="relative h-10 w-10 flex-shrink-0">
              <img src="/logos/SDAlogo.svg" alt="Science Development Accelerator" className="h-full w-full object-contain" />
            </div>
        ...
        {mobileOpen && (
          <div
            ...
            style={{ borderTop: '1px solid var(--border)', background: 'rgba(8,8,16,0.98)' }}
          >
