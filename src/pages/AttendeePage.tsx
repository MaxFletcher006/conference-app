...
const T = {
  en: {
    ...
    ticketSupport:   'If you have any problems purchasing tickets, please contact us at',
  ...
  mn: {
    ...
    ticketSupport:   'Хэрэв танд тасалбар авахтай асуудал гарвал холбогдоно уу:',
              ...
              {events.map(ev => {
                ...
                return (
                  <div key={ev.id} style={{
                    ...
                    {/* Sessions + Speakers — only visible after expanding */}
                    {isExpanded && (
